"""
RAG Agent - Core Implementation
Handles PDF processing, embedding generation, and vector storage in Supabase
"""
...
class RAGAgent:
    """
    RAG Agent for document processing and question answering
    """
    
    def __init__(self):
        """Initialize the RAG agent with Gemini and Supabase"""
        ...
        print(f"✅ Gemini embeddings initialized ({GEMINI_EMBEDDING_MODEL})")
